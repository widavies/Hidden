...
public class Structures {
	...
	public static final byte[][] TIER_1 = {
		...
		{TileIDs.GLASS, TileIDs.CEMENT, TileIDs.GLASS},
		{TileIDs.GLASS, TileIDs.LOCKED_DOOR_LEFT, TileIDs.GLASS}
	};
	
	public static final byte[][] TIER_2 = {
			{TileIDs.GLASS, TileIDs.GLASS, TileIDs.GLASS, TileIDs.GLASS},
			{TileIDs.GLASS, TileIDs.CEMENT, TileIDs.CEMENT, TileIDs.GLASS},
			{TileIDs.GLASS, TileIDs.LOCKED_DOOR_LEFT, TileIDs.LOCKED_DOOR_RIGHT, TileIDs.GLASS}
	};
	
	public static final byte[][] TIER_3 = {
			{TileIDs.WALL, TileIDs.WALL, TileIDs.WALL, TileIDs.WALL},
			{TileIDs.WALL, TileIDs.CEMENT, TileIDs.CEMENT, TileIDs.WALL},
			{TileIDs.WALL, TileIDs.CEMENT, TileIDs.CEMENT, TileIDs.WALL},
			{TileIDs.WALL, TileIDs.LOCKED_DOOR_LEFT, TileIDs.LOCKED_DOOR_RIGHT, TileIDs.WALL}
	};
	...
	public static final byte[][] TIER_5 = {
			...
			{TileIDs.WALL_2, TileIDs.CEMENT_2, TileIDs.CEMENT_2, TileIDs.WALL_2},
			{TileIDs.WALL_2, TileIDs.LOCKED_DOOR_LEFT, TileIDs.LOCKED_DOOR_RIGHT, TileIDs.WALL_2}
	};
	...
	public static final byte[][] TIER_6 = {
			...
			{TileIDs.WALL_2, TileIDs.CEMENT_2, TileIDs.CEMENT_2, TileIDs.CEMENT_2, TileIDs.WALL_2},
			{TileIDs.WALL_2, TileIDs.LOCKED_DOOR_LEFT, TileIDs.WALL_2, TileIDs.LOCKED_DOOR_RIGHT, TileIDs.WALL_2}
	};
